...
Run the sync script:
```bash
node .claude/skills/brand-system/brand/scripts/sync-brand-to-tokens.cjs
```
...
node .claude/skills/brand-system/brand/scripts/inject-brand-context.cjs --json | head -30
