...
python .claude/skills/brand-system/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .claude/skills/brand-system/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
