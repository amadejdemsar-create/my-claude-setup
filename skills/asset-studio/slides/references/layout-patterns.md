...
python .claude/skills/brand-system/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/skills/brand-system/design-system/scripts/search-slides.py "traction slide" \
