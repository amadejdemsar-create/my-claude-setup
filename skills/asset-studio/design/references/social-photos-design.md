...
1. **`brand-system` (Part 1)** — Extract brand colors, fonts, voice from user's project
2. **`brand-system` (Part 2)** — Get design tokens (spacing, typography scale, color palette)
