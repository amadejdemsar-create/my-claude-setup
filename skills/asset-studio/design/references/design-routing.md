...
**Brand:**
```bash
node .claude/skills/brand-system/brand/scripts/inject-brand-context.cjs
node .claude/skills/brand-system/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .claude/skills/brand-system/design-system/scripts/generate-tokens.cjs -c tokens.json
node .claude/skills/brand-system/design-system/scripts/validate-tokens.cjs -d src/
```
